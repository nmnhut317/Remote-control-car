...
#define xmin_Pin GPIO_PIN_0
#define xmin_GPIO_Port GPIOB
#define xplus_Pin GPIO_PIN_1
#define xplus_GPIO_Port GPIOB
#define ymin_Pin GPIO_PIN_2
#define ymin_GPIO_Port GPIOB
#define yplus_Pin GPIO_PIN_3
#define yplus_GPIO_Port GPIOB
